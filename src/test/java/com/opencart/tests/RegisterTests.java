...
public class RegisterTests extends BaseTest {
	...
	public void testPasswordComplexity() {
	    ...
	    try {
	        ...
	        // Check if registration failed (which indicates password complexity enforcement)
	        ...
	        if (!isSuccess) {
	            ...
	            boolean hasPasswordError = errors.stream().anyMatch(error -> 
	            ...
	            ExtentTestManager.logPass("Password complexity validation completed - weak password correctly rejected");
	        } else {
	            ExtentTestManager.logWarn("Registration succeeded with weak password - complexity requirements may not be enforced");
	        }
	...
	/**
	 * TC_RF_001-TS_022: Validate registration fails without Privacy Policy agreement
	 */
	...
	public void testRegistrationWithoutPrivacyPolicy(String firstName, String lastName, String email, String phone,
	    ...
	    try {
	        ...
	        if (!isSuccess) {
	            ...
	            boolean hasPrivacyError = errors.stream().anyMatch(error -> 
	                error.toLowerCase().contains("privacy") || error.toLowerCase().contains("policy"));
	            ...
	            ExtentTestManager.logPass("Privacy Policy requirement validation completed for: " + firstName + " " + lastName);
	        } else {
